    ...
    return (
        <Container className={styles.container}>
            ...
            <Box className={styles.content}>
                ...
                <p>
                    {"We began the project by creating our problem statement detailed above. Because we knew the problem we were trying to address, and because our team included many members who had been affected by "}
                ...
                <Box className={styles.personaContainer}>
                    <Image src={'/persona_1.png'} width={500} height={280} alt="A persona bio of Sarah Thompson, a disability rights activist."/>
                    <Image src={'/persona_2.png'} width={500} height={280} alt="A persona bio of Assad Harris, a physically disabled software engineer."/>
                </Box>
                ...
                <p>
                    {"We decided to follow the Crazy 8 (or as our Professor refers to it, the Creative 8) process for ideation. This means we each took a limited amount of time to sketch "}
                ...
                <Box className={styles.imageContainer}>
                    <Image src={'/creative_8.png'} width={400} height={300} alt="Rough sketches for the PathwayPal interface, leveraging the crazy 8 ideation technique."/>
                </Box>
                ...
                <ul>
                    <li>
                        {"I believe we could've benefitted from following design thinking and conducted user research with a wider group of people beyond just team members. This would have "}
