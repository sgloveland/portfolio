...
import { Container, Box, Button, IconButton, Icon } from '@mui/material';
...
const PathwayPals = () => {
    return (
        <Container className={styles.container}>
            <Head>
                <title>PathwayPal</title>
                <meta name="description" content="Generated by create next app" />
            </Head>
            <Box className={styles.header}>
                <IconButton className={styles.back} aria-label='Back' href={'/'}>
                    <ArrowBackIcon className={styles.backIcon} />
                </IconButton>
                <h1 className={styles.title}>PathwayPal</h1>
            </Box>
            <Box className={styles.content}>
                ...
                <Box className={styles.personaContainer}>
                    <Image src={'/persona_1.png'} width={1000} height={560} alt="A persona bio of Sarah Thompson, a disability rights activist."/>
                    <Image src={'/persona_2.png'} width={1000} height={580} alt="A persona bio of Assad Harris, a physically disabled software engineer."/>
                </Box>
