  ...
  return (
    <Container>
      ...
      <Box className={styles.buttonContainer}>
        <Button
          variant="outlined"
          className={`${cardIndex === 0 ? styles.activeButton : styles.button}`}
        ...
        <Button
          variant="outlined"
          className={`${cardIndex === 1 ? styles.activeButton : styles.button}`}
      ...
      <Box className={styles.carouselContainer}>{renderTab()}</Box>
    </Container>
  );
};
